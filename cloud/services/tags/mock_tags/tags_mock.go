...
func (m *MockTagScope) APIServerIP() string {
	m.ctrl.T.Helper()
...
func (mr *MockTagScopeMockRecorder) APIServerIP() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "APIServerIP", reflect.TypeOf((*MockTagScope)(nil).APIServerIP))
}
