...
func (m *MockLBScope) APIServerIP() string {
	m.ctrl.T.Helper()
...
func (mr *MockLBScopeMockRecorder) APIServerIP() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "APIServerIP", reflect.TypeOf((*MockLBScope)(nil).APIServerIP))
}
