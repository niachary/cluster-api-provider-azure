...
func autoConvert_v1alpha2_AzureClusterSpec_To_v1alpha3_AzureClusterSpec(in *AzureClusterSpec, out *v1alpha3.AzureClusterSpec, s conversion.Scope) error {
	...
	// WARNING: in.ControlPlaneEndpoint requires manual conversion: inconvertible types (string vs sigs.k8s.io/cluster-api/api/v1alpha3.APIEndpoint)
...
func autoConvert_v1alpha3_AzureClusterSpec_To_v1alpha2_AzureClusterSpec(in *v1alpha3.AzureClusterSpec, out *AzureClusterSpec, s conversion.Scope) error {
	...
	out.Location = in.Location
	// WARNING: in.ControlPlaneEndpoint requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/v1alpha3.APIEndpoint vs string)
	// WARNING: in.ControlPlaneEndpointIP requires manual conversion: does not exist in peer-type
...
func autoConvert_v1alpha3_NetworkSpec_To_v1alpha2_NetworkSpec(in *v1alpha3.NetworkSpec, out *NetworkSpec, s conversion.Scope) error {
	...
	// WARNING: in.HasPublicIP requires manual conversion: does not exist in peer-type
	if in.Subnets != nil {
		in, out := &in.Subnets, &out.Subnets
